function CitadelleRP.API:GetColor(col, theme)
    if !theme then
        theme = CitadelleRP.API.Themes.Selected
    end

    local colors = CitadelleRP.API.Themes.List[CitadelleRP.API.Themes.Selected].colors
...
function CitadelleRP.API:LerpColor(btn,strName,tblColor,boolHovered,intTimeFade)
