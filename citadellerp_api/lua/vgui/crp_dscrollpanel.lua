...
function PANEL:Init()
    self:PaintScrollBar(CitadelleRP.API:GetColor('primary'),CitadelleRP.API:GetColor('secondary'),CitadelleRP.API:GetColor('secondary'),CitadelleRP.API:GetColor('lightRed'))
end
...
vgui.Register("CRPScrollPanel",PANEL,"DScrollPanel")
